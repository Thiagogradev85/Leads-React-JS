...
const TYPE_COLOR = {
  'Novo':      '#22c55e',  // verde    — cliente novo
  'Contatado': '#60a5fa',  // azul     — foi contatado
  'Catalogo':  '#facc15',  // amarelo  — pediu catálogo
  'Compra':    '#fbbf24',  // dourado  — finalizou compra
}

// Merge all detail lists into one entry per client, combining labels
